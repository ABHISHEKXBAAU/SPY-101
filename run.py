# Orignally Written By Abhishek Rai
...
88  `8D 88'     88   88 d8' `8b __ 
    _   ___ _  _ ___ ___ _  _ ___ _  __
   /_\ | _ ) || |_ _/ __| || | __| |/ / 
  / _ \| _ \ __ || |\__ \ __ | _|| ' <  
...
def Main_Abhishek():
		...
		if shm =='1':
			...
			os.system('xdg-open https://www.facebook.com/sasuke0017')
			Main_Abhishek()
		elif shm =='0':
...
def rd1(ids,passlist):
	try:
		...
		sys.stdout.write('\r\r\33[1;37m[Abhishek]  %s|  OK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
		for pas in passlist:
...
def api1(ids,names,passlist):
	try:
		global ok,loop,sim_id
		sys.stdout.write('\r\r\33[1;37m[Abhishek-M1]  %s|  OK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
		fn = names.split(' ')[0]
		try:
			ln = names.split(' ')[1]
		except:
